...
上記の流れに続けて、本記事でも2018年に行われたアップデートを紹介していきます。ただ今回は少しアプローチを変えて、**スクリーンキャスト風に GitHub 上の[コミットログ](https://github.com/coderdojo-japan/coderdojo.jp/commits/main)や[開発背景](https://github.com/coderdojo-japan/coderdojo.jp/pulls?utf8=%E2%9C%93&q=is%3Aclosed+)などを説明**してみようかなと思います。
...
- [開発者向けドキュメント](https://github.com/coderdojo-japan/coderdojo.jp/blob/main/docs/how-to-add-dojo.md)の整備
