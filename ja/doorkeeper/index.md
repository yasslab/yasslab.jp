...
<div class="row justify-content-start no-gutters">
  ...
  <div class="col-xs-9"><b><a href="https://yasslab.jp/">YassLab 株式会社</a></b>
    <br><br>
    本イベントページはオープンソースコミュニティを支援する <a href="https://yasslab.jp/">YassLab 株式会社</a>が提供しております。詳細はコミュニティ運営者向け資料『<a href="https://yasslab.jp/ja/doorkeeper/">Doorkeeper スポンサーシップ</a>』をご参照ください。
  </div>
</div>
```
...
イベント枠を提供するまでの手続きは大きく分けて２つあります。いずれに場合においても、まずは最下部の[お問い合わせ先](#contact)より次の旨を添えてご連絡いただけると幸いです 📮 ✉️💨
...
<ol class="tos">
  ...
  <li>本スポンサーシップは2016年9月から起算して1年単位で振り返ります。中止希望の場合は毎年8月末日までにご連絡ください。<strong>継続希望の場合はご連絡は不要</strong>です。翌年度も自動更新となります</li>
