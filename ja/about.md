...
<section class="entry_content pt-5 mb-5" id="ceo">
  <div class="container">
    ...
    <div class="text-center" style='margin: 30px auto 100px;'>
      <a href="https://speakerdeck.com/yasulab/who-am-i" target='_blank'>
	<button class="btn btn-primary external-link">スライド資料を見る</button>
      </a>
    </div>
  </div>
</section>
