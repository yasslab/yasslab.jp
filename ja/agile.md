  ...
  <div class="container">
	...
	<p>上記のモデル契約書を具体化した契約書が、次の契約書になります。</p>
	  ...
	  <small> (作成: YassLab 株式会社)</small>
        ...
        <p>なお上記はあくまで具体例の１つとなりますので、個別のカスタマイズや所定のテンプレートなどあれば柔軟に対応いたします。</p>
      </div><!--//col-->
    </div><!--//row-->
  </div><!--//container-->
</section>
...
<section class="entry_content pt-5" id="price">
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        <h2 class="mb-5"><a href="#price">基本料: 80〜120万/月 ×
	  稼働数</a></h2>
        <ul>
          <li>月120〜160時間相当の稼働数を『１』とした金額が基本料となります</li>
      	  <li>安定的に価値を出すため、２名以上のチームによる稼働を推奨しています</li>
          <li><a href='#clients'>これまでの事例</a>では、２〜３名のチームで開発支援をするケースが多いです</li>
        </ul>
      </div><!--//col-->
    </div><!--//row-->
  </div><!--//container-->
...
<section class="entry_content pt-5 pb-5" id="schedule">
  <div class="container">
	...
	<p class='text-center'>
	  更新日: {{ site.data.schedule[0].updated_at }}
	</p>
