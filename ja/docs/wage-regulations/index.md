...
{% include numbering-heading.html tag='h3' title='賃金の種類' %}
賃金の構成は、次のとおりとする。
...
{% include numbering-heading.html tag='h3' title='計算期間および支払日' %}
...
{% include numbering-heading.html tag='h3' title='給与の支払いおよび控除' %}
...
{% include numbering-heading.html tag='h3' title='語句の定義' %}
...
{% include numbering-heading.html tag='h3' title='基本給' %}
...
{% include numbering-heading.html tag='h3' title='残業代' %}
残業代は、次の労働に対し支給する。
...
{% include numbering-heading.html tag='h3' title='賞与' %}
